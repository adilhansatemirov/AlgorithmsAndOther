...
public class Main extends Application {
  ...
  public void start(final Stage stage) throws Exception {
    ...
    final Scene scene = new Scene(group, 600, 600, Color.GHOSTWHITE);
    ...
    path.getElements().add(new CubicCurveTo(30, 50, 580, 120, 150, 320));
    path.getElements().add(new CubicCurveTo(200, 1120, 110, 140, 380, 240));
    path.setOpacity(0.5);
